...
<body>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Por favor, Ingresa tu usario y restablece tu contraseña</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form id="form-restaurar">
                                        ...
                                        <!-- Botón Buscar -->
                                        <div class="mb-3">
                                            <button type="button" id="btnBuscarUsuario" class="btn btn-primary w-100">Buscar Usuario</button>
                                        </div>

                                        <!-- Opciones si el usuario existe -->
                                        <div id="restaurarOpciones" class="d-none">
                                            <div class="mb-3">
                                                <label class="form-label" for="password-input">Nueva Contraseña</label>
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" class="form-control pe-5" placeholder="Ingresa tu nueva contraseña" id="usu_pass" name="usu_pass">
                                                </div>
                                            </div>
    ...
    <script src="restaurar.js"></script>
</body>
